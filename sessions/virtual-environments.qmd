...
> "Reproducibility begins with declaring what our software needs to run. If an environment cannot be rebuilt from version-controlled configuration, an analysis cannot be trusted to produce the same results tomorrow."
...
## Milestone 1: Declaring the Environment (`set-up-venv`)
...
### Step 2: Pin Python 3.12 and Initialize `uv`
...
### Step 3: Inspect and Update `pyproject.toml`
...
### Step 4: Ensure `.venv/` is Ignored by Git
...
### Step 5: Create and Test the Environment
...
### Step 6: Configure VS Code's Python Interpreter
...
### Step 7: Commit, Push, Review, and Merge Milestone 1
...
## Milestone 2: Undeclared Dependencies (`add-word-counting`)
...
### Step 2: Add the Word Counting Script
...
### Step 3: Experience the Intentional Failure
...
### Step 4: Declare and Resolve the Dependency
...
### Step 5: Run the Script Successfully
...
### Step 6: Commit, Push, Review, and Merge Milestone 2

Remove the generated CSV file before committing (we will organize outputs properly in Milestone 3):
...
## Milestone 3: Separating Data from Code (`separate-data`)
...
### Step 3: Run the Script with Clear Separation
...
### Step 4: Ignore Generated Intermediate Data
...
### Step 5: Inspect the Project Tree
...
### Step 6: Commit, Push, Review, and Merge Milestone 3
...
## Milestone 4: Creating a Reusable Package (`create-package`)
...
### Step 2: Build the `src/` Package Structure
...
### Step 3: Configure `pyproject.toml` for the `src/` Layout
...
### Step 4: Interactive Visualization with Marimo
...
### Step 5: Update the Project `README.md`
...
### Step 6: Commit, Push, Review, and Merge Milestone 4
