...
The diagram below shows how you and your partner collaborate during this session:
...
## Create an Empty Repository and Initialize Git
...
## Add the Proposed Book and Update the Inventory
...
## Pull Merged Changes and Inspect History

Now **Partner A** syncs their local clone to pull the new commits from GitHub:

1. In VS Code, open the Source Control view.
2. Click the `...` (More Actions) menu at the top of the Source Control panel, and select **Pull** (or use the Sync status bar button).
